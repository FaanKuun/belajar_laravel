                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ asset('admin/delete-peminjaman/' .$item->id)}}" button type="button" class="btn btn-danger" onclick="return confirm('Yakin Akan Menghapus Data Ini!?')"></button><i class="fa fa-trash"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-groub">
                    <input type="text" class="form-control mb-4" name="nama" placeholder="Masukkan nama">
                </div>
                <label>Judul Buku</label>
                <div class="form-groub">
                    <input type="text" class="form-control mb-4" name="judul_buku" placeholder="Masukkan judul buku">
                </div>
                <label>Tanggal Peminjaman</label>
                <div class="form-groub">
                    <input type="date" class="form-control mb-4" name="tgl_peminjaman">
                </div>
                <label>Tanggal Kembali</label>
                <div class="form-groub">
                    <input type="date" class="form-control mb-4" name="tgl_kembali">
                </div>
            </div>
